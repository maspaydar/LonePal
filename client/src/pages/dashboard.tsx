  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <Card>
          <CardHeader>
            <CardTitle className="text-base">Resident Status</CardTitle>
          </CardHeader>
            ...
            {dashData.residents?.map((resident: any) => (
              ...
              >
                ...
                <div className="flex items-center gap-2">
                  <div className={`w-2 h-2 rounded-full ${getStatusColor(resident.status)}`} />
                  <span className="text-xs capitalize">{resident.status}</span>
                </div>
              </div>
            ))}
          </CardContent>
