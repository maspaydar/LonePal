...
export function BrandMark({
  ...
  const word = variant === "dark" ? "text-text-inverse" : "text-text-primary";
  return (
    <div className={`flex items-center gap-[1vw] ${className}`}>
      <div className="flex aspect-square w-[3.4vw] items-center justify-center rounded-[0.8vw]" style={{ backgroundColor: 'var(--color-primary)' }}>
        <Shield className="w-[1.9vw]" style={{ color: 'var(--color-text-inverse)' }} />
      </div>
      <span
